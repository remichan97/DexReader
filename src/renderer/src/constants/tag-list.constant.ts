/**
 * MangaDex Tag List Constant (Renderer Copy)
 *
 ...
 * Total Tags: 76
 *
 * Note: This is a renderer-side copy of the main process constant.
 * Tags are static data that don't require IPC communication.
 *
 * Tag Groups:

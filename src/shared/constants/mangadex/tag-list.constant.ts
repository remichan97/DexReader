/**
 * MangaDex Tag List Constant
 *
 * Complete list of manga tags available on MangaDex.
 * Source: GET https://api.mangadex.org/manga/tag
 * Last Updated: 13 December 2025
 * Total Tags: 76
 *
 * Note: These tags are relatively static but may change over time.
 * If tags become outdated, either update this constant or implement
 * dynamic fetching from the API.
 *
 * Tag Groups:
 * - genre: Action, Romance, Horror, etc.
 * - theme: Isekai, School Life, Magic, etc.
 * - format: Oneshot, Long Strip, Doujinshi, etc.
 * - content: Gore, Sexual Violence (content warnings)
 */
...
export const TagList = {
  ...
  FourKoma: 'b11fda93-8f1d-4bef-b2ed-8803d3733170',
...
/**
 * Helper to get tag IDs by group
 */
